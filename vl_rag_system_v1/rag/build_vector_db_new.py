...
class ExhibitVectorizer:
    def __init__(self, db_path=None):
        ...
        default_db_path = PROJECT_ROOT / "data" / "exhibit_vector_db"
        resolved_db_path = Path(db_path or os.getenv("EXHIBIT_VECTOR_DB", default_db_path))
...
def main():
    ...
    # 数据集路径。Ubuntu 下可用 EXHIBIT_IMAGE_DATASET 指向真实图片目录。
    dataset_path = os.getenv(
        "EXHIBIT_IMAGE_DATASET",
        str(PROJECT_ROOT / "data" / "创设展品图" / "原始图片"),
    )
